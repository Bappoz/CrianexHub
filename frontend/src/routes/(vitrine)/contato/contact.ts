...
export function resolveStatus(httpStatus: number): { status: SubmitStatus; errorKey: 'rate' | 'generic' | null } {
...
export function defaultForm(): FormState {
  return { name: '', email: '', company: '', product: 'avali', message: '', consent: false, website: '' };
}
