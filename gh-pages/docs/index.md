...
O escopo acadêmico compreende a execução das seguintes atividades de ER, organizadas conforme o processo iterativo adotado (**FDD + Kanban**):

| Atividade de ER                | Técnicas / Artefatos Utilizados                                                                                                                                                                                                           |
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Elicitação de Requisitos**   | Entrevistas semiestruturadas, Rich Picture, Diagrama de Ishikawa, Brainstorming com stakeholders (Otávio Maya — CTO)                                                                                                                      |
| **Análise e Consenso**         | Características de Produto (CPs), Conjuntos de Funcionalidades (Feature Sets) e Funcionalidades (Features) no formato FDD — `<ação> o <resultado> <por/para> um <objeto>` — com critérios de aceitação no formato _Dado / Quando / Então_ |
| **Priorização de Requisitos**  | Modelo de Valor × Esforço — Índice de Prioridade `IP = VB / ((CX + ES) / 2)`, alinhado ao valor de negócio das CPs e Objetivos Específicos (OEs)                                                                                          |
| **Verificação e Validação**    | Definition of Ready (DoR), Definition of Done (DoD), inspeções formais via Pull Request, validação contínua com o cliente ao longo das iterações                                                                                          |
