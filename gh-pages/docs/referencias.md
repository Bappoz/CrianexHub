...
PALMER, Steve R.; FELSING, John M. **A Practical Guide to Feature-Driven Development**. Upper Saddle River: Prentice Hall, 2002.

ANDERSON, David J. **Kanban: Successful Evolutionary Change for Your Technology Business**. Sequim: Blue Hole Press, 2010.

BECK, Kent et al. **Manifesto para Desenvolvimento Ágil de Software**. 2001. Disponível em: <https://agilemanifesto.org/iso/ptbr/manifesto.html>. Acesso em: mai. 2026.

---

## Artigos e Publicações Acadêmicas

NORTH, Dan. **Introducing BDD**. Better Software Magazine, mar. 2006. Disponível em: <https://dannorth.net/introducing-bdd>. Acesso em: mai. 2026.

---

## Links e Recursos Online

MKDOCS. **MkDocs — Project documentation with Markdown**. Disponível em: <https://www.mkdocs.org>. Acesso em: mai. 2026.

SQUIDFUNK. **Material for MkDocs**. Disponível em: <https://squidfunk.github.io/mkdocs-material>. Acesso em: mai. 2026.

GITHUB. **GitHub Docs**. Disponível em: <https://docs.github.com>. Acesso em: mai. 2026.
