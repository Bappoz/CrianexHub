...
> **Legenda:** <span class="badge badge--green">Aplicado</span> aplicado no backlog · <span class="badge badge--yellow">Pendente</span> pendente de aplicação · <span class="badge badge--red">Crítico</span> achado crítico · <span class="badge badge--yellow">Atenção</span> achado de atenção
...
| ----------- | ----- | ------------------------------------------------------------------------------------------- | ------ |
| Processo    | MP.01 | Modelo FDD: 100% iterativo → fase de construção iterativa                                   | <span class="badge badge--green">Aplicado</span>     |
| Processo    | MP.02 | Direção da priorização: bottom-up → top-down                                                | <span class="badge badge--green">Aplicado</span>     |
| Escopo      | ES.01 | F02 removida — absorvida por F01                                                            | <span class="badge badge--yellow">Pendente</span>     |
| Escopo      | ES.02 | F05 removida — RF07 reproposto + novo RF para F04                                           | <span class="badge badge--yellow">Pendente</span>     |
| Escopo      | ES.03 | F07 absorvida por F06 — RF18 migra para F06                                                 | <span class="badge badge--yellow">Pendente</span>     |
| Escopo      | ES.04 | F22 — RF42 detalhado em 3 RFs                                                               | <span class="badge badge--yellow">Pendente</span>     |
| Escopo      | ES.05 | F25/F26/F27 — agrupadora dividida em 3 features atômicas                                    | <span class="badge badge--green">Aplicado</span>     |
| Verificação | V.01  | MFA/2FA: decisão de não implementar por solicitação do cliente                              | <span class="badge badge--green">Aplicado</span>     |
| Verificação | V.02  | Conflito de numeração RF53 após mudanças de escopo                                          | <span class="badge badge--yellow">Atenção</span>     |
| Escopo      | ES.06 | F10 — Adicionado RF48 para edição de dados do próprio perfil                                | <span class="badge badge--green">Aplicado</span>     |
| Escopo      | ES.07 | F14 — Adicionado RF49 para consentimento e detalhamento de LGPD                             | <span class="badge badge--green">Aplicado</span>     |
| Escopo      | ES.08 | F15 — Adicionado RF50 para consulta de detalhes de produtos SaaS                            | <span class="badge badge--green">Aplicado</span>     |
| Escopo      | ES.09 | F15 — Adicionado RF51 para consentimento e política de cookies                              | <span class="badge badge--green">Aplicado</span>     |
| Escopo      | ES.10 | F08 — Antigo RF15 refatorado em 3 RFs atômicos (CRUD de templates) e movido de F27 para F08 | <span class="badge badge--green">Aplicado</span>     |
...
| **Status**    | <span class="badge badge--green">Aplicado</span> Adotado desde IT1                                                                                                                                 |
...
| **Status**         | <span class="badge badge--green">Aplicado</span> realizado IT2                                                                                                                                                          |
...
| **Status**           | <span class="badge badge--yellow">Pendente</span> Remover F02 e RF03 da rastreabilidade                                                                                                                                                                                                                                                     |
...
| **Status**           | <span class="badge badge--yellow">Pendente</span> Renomear RF07, criar novo RF, remover F05 da rastreabilidade                                                                                                          |
...
| **Status**           | <span class="badge badge--yellow">Pendente</span> Remover F07, mover RF18 para F06 na rastreabilidade                                                                                                                                                 |
...
| **Status**       | <span class="badge badge--yellow">Pendente</span> RF42 atualizado; criar e numerar os 2 novos RFs na rastreabilidade                                                            |
...
| **Status**          | <span class="badge badge--green">Aplicado</span> Já refletido na rastreabilidade                                                                                                                                                         |
...
| **Status**  | <span class="badge badge--green">Aplicado</span> e refletido no mapeamento visual do Miro                                                                                                                                                                                                                                               |
