...
**Local:** Discord / Ferramenta Miro (Duração: ~3h10)
...
| Camille | Chief Architect / Class Owner | Presente (Afastou-se aos 01h11m) |

---

## Pauta

1. Definição e mapeamento de Requisitos Não Funcionais (RNFs) por característica
2. Reorganização estrutural e fusão das Características de Produto (CP4 e CP5)
3. Alinhamento da Matriz de Rastreabilidade e Regras Globais
4. Preenchimento da Matriz de Valor x Esforço para o MVP
5. Revisão do Cronograma de Entrega da Unidade 2 e Estratégia de Código
...
| 2 | Finalizar as seções pendentes (3 e 4) do Documento de Visão no GitHub | Camille | 15/05/2026 |
| 3 | Resolver a issue pendente de Estratégias no repositório | Camille | 16/05/2026 |
| 4 | Atualizar a numeração, nomenclatura de CPs (1 a 10) e rastreabilidade no Git Pages | Lucas | 17/05/2026 |
| 5 | Concluir o protótipo de alta fidelidade no Figma para validação do cliente | Lucas / Camille | 18/05/2026 |
| 6 | Transcrever e estruturar as *Features Cards Specifications* (BDD) de cada item validado | Toda a Equipe | 18/05/2026 |
