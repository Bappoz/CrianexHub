...
const upload = multer({
    ...
    fileFilter: (req, file, cb) =>{ //cb -> callback para o multer de verificação de passagem
        ...
        .insert([
            {
                ...
                icon_text, color,
                category_pt, category_en,
                published, display_order, slug, image_url
            }
        ])
