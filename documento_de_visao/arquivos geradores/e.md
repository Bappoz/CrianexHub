...
|----------|--------|---------|------------------|-----|----------------|-----------|
| **IT1** | 🔄 | 28/04 até 25/05 | **Vitrine Pública** | [CP4](solucao.md#características-do-produto-cp) · [CP5](solucao.md#características-do-produto-cp) · [CP6](solucao.md#características-do-produto-cp) | "Qualquer visitante acessa a vitrine pública da Crianex, vê o portfólio de produtos SaaS com página institucional em PT/EN, em layout responsivo." | Partial Validation contínua. Formal Validation com demo focada em conversão e navegação. |
...
![Cronograma](docs/visao/images/cronograma.png)
