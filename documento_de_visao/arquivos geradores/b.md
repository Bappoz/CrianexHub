...
| OE1 | - | CP2 | Histórico de Logs e Monitoramento | Painel autenticado com visualização de logs de acesso segmentados por perfil (usuário cliente e usuário desenvolvedor), logs de atividades no sistema. Permite filtros por período, produto e tipo de evento. | Aumentar a visibilidade operacional interna; facilitar diagnóstico de problemas e auditorias de segurança; rastrear ações na plataforma em tempo real. |
...
Esse diagrama foi importante para nos organizarmos à respeito de Iterações do FDD, determinando entregas de produto baseada em valores de negócio.

![Feature/Value Matrix — Crianex Hub](docs/visao/images/matrix_valor_esforco.png)
<figure class="crianex-figure">
  <figcaption>Figura 2 — Feature/Value Matrix das Características do Produto (CP1–CP9). Fonte: Elaborado pelos autores (2026).</figcaption>
</figure>
...
![visão geral da arquitetura](docs/visao/images/visão geral da arquitetura.png)
<figure class="crianex-figure">
